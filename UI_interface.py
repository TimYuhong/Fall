...
# 最小化窗口
class MiniStatusWindow(QWidget):

    def __init__(self,MainWindow):
        super(MiniStatusWindow, self).__init__()
    ...
    def img_update(self,img_path):
        self.set_status(os.path.basename(str(img_path)) or 'Standby', level='idle')
    ...
    def windowinit(self):
        ...
        self.lab.setGeometry(0, 0, 256, 256)
        self.set_status('Standby', level='idle')
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphicsView_4.setMinimumSize(QtCore.QSize(220, 160))
        ...
        self.graphicsView_2.setMinimumSize(QtCore.QSize(220, 160))
        self.graphicsView_2.setMaximumSize(QtCore.QSize(16777215, 16777215))
        ...
        self.graphicsView.setMinimumSize(QtCore.QSize(220, 160))
        ...
        self.graphicsView_3.setMinimumSize(QtCore.QSize(220, 160))
        self.graphicsView_3.setMaximumSize(QtCore.QSize(16777215, 16777215))
        ...
        self.graphicsView_5.setMinimumSize(QtCore.QSize(220, 160))
        ...
        self.graphicsView_6.setMinimumSize(QtCore.QSize(220, 160))
        ...
        self.graphicsView_pointcloud.setMinimumHeight(260)  # 设置最小高度，确保可见
        ...
        self.textEdit_pointcloud_log.setMaximumHeight(140)  # 限制高度
        self.textEdit_pointcloud_log.setMinimumHeight(90)  # 设置最小高度
        ...
        self.graphicsView_trajectory.setMinimumHeight(260)
        ...
        self.graphicsView_height.setMinimumHeight(260)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_7.setTitle(_translate("MainWindow", "跌倒检测与采样"))
        self.label_5.setText(_translate("MainWindow", "color："))
        self.groupBox_3.setTitle(_translate("MainWindow", "监测"))
        self.pushButton_15.setText(_translate("MainWindow", "开始监测"))
        ...
        self.label_10.setText(_translate("MainWindow", "跌倒状态"))
    ...
    def slot_init(self):
        ...
        self.pushButton_15.clicked.connect(self.toggle_monitor_button)
        self.set_fall_status_text('Standby')
        
    def set_fall_status_text(self, text, level='idle'):
        palette = {
            'idle': ('#f5f5f5', '#9e9e9e', '#333333'),
            'monitor': ('#e8f4ff', '#4a90e2', '#0b3d91'),
            'capture': ('#fff4e5', '#f5a623', '#8a5a00'),
        ...
        background, border, foreground = palette.get(level, palette['idle'])
        self.graphicsView_5.setText(text)
        self.graphicsView_5.setAlignment(Qt.AlignCenter)
        self.graphicsView_5.setWordWrap(True)
        self.graphicsView_5.setStyleSheet(
            "border-width: 2px;border-style: solid;"
            f"border-color: {border};background-color: {background};color: {foreground};"
            "font-size: 22px;font-weight: bold;padding: 12px;"
        )

    def toggle_monitor_button(self, force_off=False):
        enabled = self.pushButton_15.isChecked() and not force_off
        if enabled:
            self.pushButton_15.setText('停止监测')
        else:
            self.pushButton_15.setChecked(False)
            self.pushButton_15.setText('开始监测')
            self.set_fall_status_text('Standby')
